...
<html>
<head>
<title>EFREY-PHP :: !!!Uups!!! 404</title>
...
<body>
 <div class="wrap">
	<div class="logo">
			...
			<div><span class="bracket">{</span><span class="code">404</span><span class="bracket">}</span></div>
            <div style="font-size: 120%;">Ir al <a href="http://<?php echo APP_FOLDER_NAME_BY_DEFAULT?>">sitio</a> por defecto</div>
	</div>
 </div>	
